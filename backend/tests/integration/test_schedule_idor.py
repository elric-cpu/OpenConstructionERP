...
Scaffolding mirrors ``test_reporting_idor.py``: the engine is bound to the
shared PostgreSQL cluster by ``conftest.py`` before any ``from app...``
import runs (see ``feedback_test_isolation.md``).
"""
