...
MARKETPLACE_MODULES: list[MarketplaceModule] = [
    ...
    MarketplaceModule(
        ...
        description="55,719 construction cost items aligned with NRM 1/2 measurement rules. UK national rates in GBP with regional cost indices.",
        category="cost_database",
        icon="Database",
        version="2.0.0",
        size_mb=85.2,
        author=_DDC,
        tags=["UK", "GBP", "NRM", "Cost Index"],
        requires=["oe_costs"],
        price="Free",
    ),
    MarketplaceModule(
        ...
        description="55,719 construction cost items with DIN 276 classification. Berlin regional rates in EUR with regional benchmark data.",
        category="cost_database",
        icon="Database",
        version="2.0.0",
        size_mb=92.3,
        author=_DDC,
        tags=["DACH", "EUR", "DIN 276"],
        requires=["oe_costs"],
        price="Free",
    ),
    MarketplaceModule(
    ...
    MarketplaceModule(
        ...
        description="55,719 construction cost items for the French market. Paris regional rates in EUR with DPGF classification mapping.",
        category="cost_database",
        icon="Database",
        version="2.0.0",
        size_mb=88.1,
        author=_DDC,
        tags=["Europe", "EUR", "DPGF", "France"],
        requires=["oe_costs"],
        price="Free",
    ),
    MarketplaceModule(
    ...
    MarketplaceModule(
        ...
        description="Pre-built semantic vector index for CWICR France database. Enables AI-powered cost item search and DPGF classification matching.",
        category="vector_index",
        icon="Sparkles",
        version="1.2.0",
        size_mb=22.0,
    ...
    MarketplaceModule(
        id="converter-rvt",
        name="RVT Parser",
        description="Native RVT file parser. No proprietary CAD vendor license required. Extracts families, parameters, quantities, and spatial structure.",
        category="converter",
        icon="FileInput",
        version="0.5.0",
        size_mb=128.0,
    ...
    MarketplaceModule(
        ...
        description="Compare your estimates against regional benchmarks. Regional cost-per-m2 data (including UK construction cost index) with building type normalization.",
        category="analytics",
        icon="BarChart3",
        version="1.0.0",
        size_mb=42.5,
        author=_DDC,
        tags=["Benchmarks", "Cost Index"],
        requires=["oe_boq", "oe_costs"],
        price="Free",
    ),
