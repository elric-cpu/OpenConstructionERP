...
export const CASE_SCENES: Record<string, Scene> = {
  ...
  'carbon-from-bim-6d': (accent) => (
    <>
      ...
      <path
        ...
        strokeLinejoin="round"
      />
      <circle cx={100} cy={68} r={4.5} fill="none" stroke={accent} strokeWidth={1.4} />
      <circle cx={100} cy={68} r={1.8} fill={accent} stroke="none" />
    </>
  ),

  // Coordinate and resolve model clashes: two models overlap, a clash flares,
  // it is driven to a resolved check.
  'coordinate-and-resolve-model-clashes': (accent) => (
    <>
      <Cube cx={40} ty={22} w={16} hh={8} depth={18} top={C.blueLight} left={C.blue} right={C.blueDeep} />
  ...
  'model-quality-audit-before-issue': () => (
    <>
      ...
      <HeaderBand x={72} y={18} w={34} h={9} fill={C.blue} />
  ...
  // priced bill.
  'quantities-from-bim': (accent) => (
    <>
      <Cube cx={32} ty={24} w={15} hh={7.5} depth={17} top={C.blueLight} left={C.blue} right={C.blueDeep} />
      <path
      ...
      <HeaderBand x={62} y={20} w={44} h={9} fill={C.blue} />
  ...
  'takeoff-from-dwg': (accent) => (
    <>
      ...
      <rect x={48} y={40} width={18} height={18} fill={accent} fillOpacity={0.18} stroke={accent} strokeWidth={1.2} />
      ...
      <Chip x={82} y={46} w={22} h={11} r={2.5} fill={C.blueLight} label="12" />
    </>
  ),
  ...
  'build-an-assembly-recipe-rate': (accent) => (
    <>
      <Chip x={20} y={22} w={34} h={10} r={2} fill={C.blue} label="concrete" />
  ...
  'cost-risk-and-contingency': (accent) => (
    <>
      ...
      <path d="M82 42 V66" stroke={accent} strokeWidth={1.8} fill="none" />
      <circle cx={82} cy={42} r={2.6} fill={accent} stroke="none" />
      <rect x={20} y={20} width={14} height={14} rx={2.5} fill={C.white} stroke={C.grey1} strokeWidth={1.4} />
      <circle cx={24} cy={24} r={1.3} fill={C.blueDeep} stroke="none" />
      <circle cx={30} cy={24} r={1.3} fill={C.blueDeep} stroke="none" />
      <circle cx={27} cy={27} r={1.3} fill={C.blueDeep} stroke="none" />
      <circle cx={24} cy={30} r={1.3} fill={C.blueDeep} stroke="none" />
      <circle cx={30} cy={30} r={1.3} fill={C.blueDeep} stroke="none" />
    </>
  ),

  // Build an elemental cost plan: a building split into classified elements,
  // each carrying its cost, tagged by cost group.
  'elemental-cost-plan-and-classification': (accent) => (
    <>
      <rect x={26} y={20} width={34} height={48} rx={2} fill="none" stroke={C.grey1} strokeWidth={1.4} />
      <rect x={26} y={20} width={34} height={12} fill={C.blueLight} stroke="none" />
      <rect x={26} y={32} width={34} height={12} fill={C.blue} stroke="none" />
      <rect x={26} y={44} width={34} height={12} fill={C.blueDeep} stroke="none" />
      ...
      <Chip x={94} y={34} w={12} h={9} fill={accent} label="KG" />
    </>
  ),

  // Estimate from a cost database: pull priced items from the database into a
  // built-up bill.
  'estimate-from-cost-database': (accent) => (
    <>
      <Cylinder cx={34} top={26} rx={14} ry={5} h={30} fill={C.blue} topFill={C.blueLight} />
      <path
      ...
      <HeaderBand x={62} y={18} w={44} h={9} fill={C.blue} />
  ...
  'feasibility-budget-before-design': (accent) => (
    <>
      <path
        ...
        strokeDasharray="3 3"
      />
      <Chip x={28} y={46} w={24} h={12} r={2.5} fill={accent} label="/m2" />
      ...
      <circle cx={86} cy={44} r={3.2} fill={accent} stroke={C.white} strokeWidth={1} />
  ...
  'independent-cost-check-on-a-design': () => (
    <>
      ...
      <path d="M68 32 l-4 8 h8 z" fill={C.blueLight} stroke="none" />
  ...
  'localize-an-estimate-to-a-region': (accent) => (
    <>
      <Sheet x={18} y={18} w={38} h={50} />
      <HeaderBand x={18} y={18} w={38} h={9} fill={C.blue} />
  ...
  'price-from-pdf': (accent) => (
    <>
      ...
      <HeaderBand x={70} y={18} w={36} h={9} fill={C.blue} />
  ...
  'validate-estimate': () => (
    <>
      ...
      <HeaderBand x={22} y={16} w={44} h={10} fill={C.blue} />
  ...
  'issue-a-procurement-and-buying-schedule': () => (
    <>
      ...
      <HeaderBand x={16} y={16} w={90} h={9} fill={C.blue} />
      <RowBar x={22} y={20} w={20} h={3} fill={C.white} opacity={0.9} />
      <rect x={24} y={32} width={30} height={5} rx={2.5} fill={C.blueLight} stroke="none" />
      <rect x={40} y={41} width={34} height={5} rx={2.5} fill={C.ochre} stroke="none" />
      <rect x={30} y={50} width={26} height={5} rx={2.5} fill={C.blueLight} stroke="none" />
  ...
  'maintain-supplier-catalogs-and-buy-from-them': (accent) => (
    <>
      <Sheet x={18} y={16} w={42} h={54} />
      <HeaderBand x={18} y={16} w={42} h={10} fill={C.blue} />
      ...
      <path
        ...
        strokeLinecap="round"
      />
      <path d="M82 14 l-1 6 l6 -1" fill="none" stroke={accent} strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" />
  ...
  'procure-from-boq': (accent) => (
    <>
      <Sheet x={16} y={18} w={34} h={48} />
      <HeaderBand x={16} y={18} w={34} h={9} fill={C.blue} />
      ...
      <Cube cx={78} ty={44} w={12} hh={6} depth={12} top={C.blueLight} left={C.blue} right={C.blueDeep} />
  ...
  'respond-to-an-invitation-to-tender-as-a-subcontractor': (accent) => (
    <>
      ...
      <Chip x={22} y={48} w={20} h={8} r={2} fill={C.blueLight} label="ITT" />
      <Sheet x={58} y={18} w={32} h={44} />
      <HeaderBand x={58} y={18} w={32} h={9} fill={C.blue} />
      ...
      <path d="M94 46 l12 -5 l-4 12 l-3 -4 z" fill={accent} stroke="none" />
      <circle cx={98} cy={24} r={6} fill={C.white} stroke={C.blue} strokeWidth={1.6} />
      <path d="M98 20 v4 l3 2" stroke={C.blue} strokeWidth={1.4} fill="none" strokeLinecap="round" />
    </>
  ),
  ...
  'agree-the-final-account-and-release-retention': (accent) => (
    <>
      <Sheet x={18} y={14} w={42} h={56} />
      <HeaderBand x={18} y={14} w={42} h={10} fill={C.blue} />
      ...
      <RowBar x={24} y={59} w={20} h={4.2} fill={C.blueDeep} />
  ...
  'change-register-and-impact': (accent) => (
    <>
      <Sheet x={16} y={16} w={40} h={54} />
      <HeaderBand x={16} y={16} w={40} h={10} fill={C.blue} />
      <RowBar x={22} y={20} w={20} h={3} fill={C.white} opacity={0.9} />
      ...
      <Bar x={84} baseY={66} w={9} h={30} fill={accent} />
      <path
  ...
  // next progress claim.
  'change-to-paid-variation': (accent) => (
    <>
      ...
      <HeaderBand x={62} y={16} w={40} h={10} fill={C.blue} />
  ...
  'control-cost-against-budget': () => (
    <>
      ...
      <Bar x={26} baseY={66} w={12} h={26} fill={C.blue} />
      <Bar x={44} baseY={66} w={12} h={30} fill={C.blue} />
      <Bar x={62} baseY={66} w={12} h={38} fill={C.red} />
      <Bar x={80} baseY={66} w={12} h={24} fill={C.blue} />
  ...
  'cost-value-reconciliation': (accent) => (
    <>
      <path d="M26 66 H100" stroke={C.grey1} strokeWidth={1.2} fill="none" />
      <Bar x={36} baseY={66} w={20} h={32} fill={C.blue} />
      <Bar x={64} baseY={66} w={20} h={44} fill={C.green} />
      <path d="M56 34 H64" stroke={accent} strokeWidth={1.4} strokeDasharray="2 2" fill="none" />
      <path
        ...
        strokeLinejoin="round"
      />
      <Chip x={34} y={69} w={22} h={9} fill={C.blue} label="cost" />
  ...
  'forecast-project-cash-flow': (accent) => (
    <>
  ...
  // and tracked to paid.
  'issue-an-electronic-invoice': (accent) => (
    <>
      <Sheet x={26} y={14} w={44} h={56} />
      <HeaderBand x={26} y={14} w={44} h={10} fill={C.blue} />
      ...
      <RowBar x={32} y={53} w={20} h={4} fill={C.blueDeep} />
      <path d="M74 40 l14 -6 l-4 14 l-4 -5 z" fill={accent} stroke="none" />
      <Badge cx={92} cy={58} r={8} fill={C.green} glyph="check" />
    </>
  ),
  ...
  'milestone-progress-before-drawdown': (accent) => (
    <>
      <path d="M18 32 H98" stroke={C.grey1} strokeWidth={1.4} fill="none" />
      <rect x={20} y={29} width={24} height={6} rx={3} fill={C.blue} stroke="none" />
      <rect x={48} y={29} width={22} height={6} rx={3} fill={C.blue} stroke="none" />
      <path d="M86 24 l7 8 l-7 8 l-7 -8 z" fill={accent} stroke={C.white} strokeWidth={1.2} />
  ...
  'payment-application-and-reconciliation': () => (
    <>
      ...
      <HeaderBand x={16} y={16} w={38} h={10} fill={C.blue} />
      ...
      <RowBar x={22} y={55} w={18} h={4} fill={C.blueDeep} />
      <Chip x={62} y={30} w={22} h={10} fill={C.blueLight} label="cert" />
  ...
  'prepare-an-interim-payment-application': () => (
    <>
      ...
      <HeaderBand x={24} y={14} w={44} h={10} fill={C.blue} />
      ...
      <RowBar x={30} y={62} w={24} h={4} fill={C.blueDeep} />
  ...
  'run-a-three-way-match-before-paying-a-supplier': (accent) => (
    <>
      <Sheet x={14} y={12} w={28} h={18} />
      <Chip x={17} y={15} w={14} h={7} fill={C.blue} label="PO" />
      <Sheet x={14} y={33} w={28} h={18} />
      <Chip x={17} y={36} w={16} h={7} fill={C.blueLight} label="GRN" />
  ...
  'subcontractor-package': () => (
    <>
      ...
      <Signature x={26} y={61} w={24} color={C.blue} />
  ...
  // it, track it to cash.
  'subcontractor-self-billed-valuation': (accent) => (
    <>
      <Sheet x={22} y={16} w={40} h={54} />
      <HeaderBand x={22} y={16} w={40} h={10} fill={C.blue} />
      <RowBar x={28} y={20} w={18} h={3} fill={C.white} opacity={0.9} />
      ...
      <RowBar x={28} y={53} w={18} h={4} fill={C.blueDeep} />
      <path d="M68 38 l14 -6 l-4 14 l-4 -5 z" fill={accent} stroke="none" />
  ...
  'track-an-opportunity-from-enquiry-to-tender': () => (
    <>
      ...
      <rect x={44} y={24} width={22} height={16} rx={2.5} fill={C.blueLight} stroke="none" />
      <rect x={72} y={24} width={22} height={16} rx={2.5} fill={C.blue} stroke="none" />
  ...
  'as-built-and-om-handover': () => (
    <>
      <rect x={20} y={30} width={30} height={38} rx={2} fill={C.blue} stroke="none" />
      <path d="M18 30 L35 20 L52 30 Z" fill={C.blueDeep} stroke="none" />
      <rect x={26} y={38} width={7} height={7} rx={1} fill={C.blueLight} stroke="none" />
      <rect x={37} y={38} width={7} height={7} rx={1} fill={C.blueLight} stroke="none" />
  ...
  'check-the-asset-data-drop-before-handover': (accent) => (
    <>
      <Cube cx={30} ty={26} w={14} hh={7} depth={16} top={C.blueLight} left={C.blue} right={C.blueDeep} />
      <path
      ...
      <HeaderBand x={58} y={18} w={46} h={9} fill={C.blue} />
  ...
  'defects-liability-period-tracking': (accent) => (
    <>
      <Sheet x={18} y={16} w={40} h={54} />
      <HeaderBand x={18} y={16} w={40} h={10} fill={C.blue} />
      <RowBar x={24} y={20} w={20} h={3} fill={C.white} opacity={0.9} />
      ...
      <rect x={70} y={26} width={30} height={8} rx={3} fill={C.blue} stroke="none" />
      <path d="M76 23 v5 M94 23 v5" stroke={C.blueDeep} strokeWidth={2} strokeLinecap="round" />
      <circle cx={85} cy={44} r={7} fill="none" stroke={accent} strokeWidth={1.6} />
      <path d="M85 40 v4 l3 2" stroke={accent} strokeWidth={1.8} fill="none" strokeLinecap="round" />
    </>
  ),

  // Draft the first year maintenance budget: assets priced for planned and
  // reactive work into a first-year number.
  'draft-the-first-year-maintenance-budget': (accent) => (
    <>
      <Sheet x={18} y={16} w={40} h={54} />
      <HeaderBand x={18} y={16} w={40} h={10} fill={C.blue} />
      <RowBar x={24} y={20} w={20} h={3} fill={C.white} opacity={0.9} />
      ...
      <RowBar x={24} y={61} w={18} h={4} fill={C.blueDeep} />
      <circle cx={82} cy={34} r={13} fill={accent} stroke={C.white} strokeWidth={1.4} />
  ...
  'manage-the-drawing-register-and-transmittals': (accent) => (
    <>
      <Sheet x={16} y={16} w={46} h={54} />
      <HeaderBand x={16} y={16} w={46} h={10} fill={C.blue} />
      ...
      <Chip x={80} y={54} w={20} h={8} fill={accent} label="issued" />
    </>
  ),

  // Plan preventive maintenance from the asset register: recurring service tasks
  // scheduled across the year.
  'plan-preventive-maintenance-from-the-asset-register': (accent) => (
    <>
      <rect x={18} y={30} width={26} height={26} rx={3} fill={C.blue} stroke="none" />
      ...
      <rect x={64} y={22} width={40} height={9} rx={3} fill={C.blue} stroke="none" />
  ...
  // clean closeout.
  'raise-and-close-a-warranty-claim': (accent) => (
    <>
      <rect x={16} y={34} width={28} height={26} rx={3} fill={C.blue} stroke="none" />
  ...
  'run-a-handover-acceptance-inspection': () => (
    <>
      <rect x={18} y={34} width={26} height={34} rx={2} fill={C.blue} stroke="none" />
      <path d="M16 34 L31 24 L46 34 Z" fill={C.blueDeep} stroke="none" />
      <rect x={23} y={41} width={6} height={6} rx={1} fill={C.blueLight} stroke="none" />
      <rect x={33} y={41} width={6} height={6} rx={1} fill={C.blueLight} stroke="none" />
  ...
  'run-reactive-fm-service-after-handover': (accent) => (
    <>
      ...
      <circle cx={70} cy={42} r={10} fill={accent} stroke="none" />
      <path
  ...
  'set-up-the-asset-register-for-fm': (accent) => (
    <>
      <Sheet x={16} y={16} w={46} h={54} />
      <HeaderBand x={16} y={16} w={46} h={10} fill={C.blue} />
      <RowBar x={22} y={20} w={22} h={3} fill={C.white} opacity={0.9} />
      <RowBar x={22} y={32} w={18} h={3.2} fill={C.grey3} />
      <Chip x={44} y={30} w={12} h={6} fill={C.blueLight} label="A1" />
      <RowBar x={22} y={40} w={20} h={3.2} fill={C.grey3} />
      <Chip x={44} y={38} w={12} h={6} fill={C.blueLight} label="A2" />
      <RowBar x={22} y={48} w={16} h={3.2} fill={C.grey3} />
      <Chip x={44} y={46} w={12} h={6} fill={C.blueLight} label="A3" />
      <path
  ...
  'balance-the-portfolio-and-level-resources': () => (
    <>
      <rect x={16} y={24} width={26} height={5} rx={2.5} fill={C.blue} stroke="none" />
      <rect x={16} y={33} width={34} height={5} rx={2.5} fill={C.blueLight} stroke="none" />
      <rect x={16} y={42} width={20} height={5} rx={2.5} fill={C.blue} stroke="none" />
      <rect x={16} y={51} width={30} height={5} rx={2.5} fill={C.blueLight} stroke="none" />
      ...
      <Bar x={64} baseY={66} w={10} h={24} fill={C.blueLight} />
      <Bar x={80} baseY={66} w={10} h={42} fill={C.red} />
      <Bar x={94} baseY={66} w={10} h={20} fill={C.blueLight} />
  ...
  // milestone.
  'build-the-baseline-programme': (accent) => (
    <>
      <Sheet x={16} y={16} w={90} h={54} />
      <HeaderBand x={16} y={16} w={90} h={9} fill={C.blue} />
      <RowBar x={22} y={20} w={20} h={3} fill={C.white} opacity={0.9} />
      ...
      <rect x={60} y={50} width={22} height={5} rx={2.5} fill={C.blueLight} stroke="none" />
      ...
      <path d="M92 47 l4 5 l-4 5 l-4 -5 z" fill={accent} stroke={C.white} strokeWidth={1} />
    </>
  ),
  ...
  'compile-weekly-progress-report': () => (
    <>
      ...
      <rect x={20} y={24} width={20} height={5} rx={2.5} fill={C.blue} stroke="none" />
      <rect x={20} y={33} width={36} height={5} rx={2.5} fill={C.grey3} stroke="none" />
      <rect x={20} y={33} width={22} height={5} rx={2.5} fill={C.blue} stroke="none" />
      <rect x={20} y={42} width={26} height={5} rx={2.5} fill={C.grey3} stroke="none" />
      <rect x={20} y={42} width={12} height={5} rx={2.5} fill={C.blue} stroke="none" />
      <rect x={16} y={58} width={22} height={16} rx={2} fill={C.blueLight} stroke={C.white} strokeWidth={1.2} />
      <circle cx={22} cy={63} r={2} fill={C.white} stroke="none" />
      <path d="M18 72 l6 -5 l4 3 l4 -4 l4 6 z" fill={C.blueDeep} stroke="none" />
      <Sheet x={76} y={20} w={30} h={44} />
      <HeaderBand x={76} y={20} w={30} h={9} fill={C.blue} />
  ...
  'crew-and-plant-lookahead-balance': (accent) => (
    <>
      <path d="M20 66 H104" stroke={C.grey1} strokeWidth={1.2} fill="none" />
      <Bar x={28} baseY={66} w={12} h={34} fill={accent} />
      <Bar x={42} baseY={66} w={12} h={24} fill={C.grey2} />
      <Bar x={68} baseY={66} w={12} h={28} fill={accent} />
      <Bar x={82} baseY={66} w={12} h={30} fill={C.grey2} />
      <circle cx={34} cy={20} r={4} fill={accent} stroke="none" />
      <path d="M28 30 c0 -5 3 -8 6 -8 s6 3 6 8 z" fill={accent} stroke="none" />
      <rect x={74} y={16} width={14} height={12} rx={2} fill={C.ochre} stroke="none" />
      <circle cx={77} cy={30} r={2.4} fill={C.blueDeep} stroke="none" />
      <circle cx={85} cy={30} r={2.4} fill={C.blueDeep} stroke="none" />
    </>
  ),

  // Earned value and forecast: planned against earned value, extended to a
  // forecast outturn.
  'earned-value-and-forecast': (accent) => (
    <>
      ...
      <path d="M18 66 C36 62 52 50 70 44" fill="none" stroke={C.blue} strokeWidth={2.4} strokeLinecap="round" />
      <path
        ...
        strokeLinecap="round"
      />
      <circle cx={70} cy={44} r={2.6} fill={C.blue} stroke="none" />
      <circle cx={100} cy={30} r={2.6} fill={accent} stroke="none" />
    </>
  ),

  // Plan repetitive work with takt and line of balance: parallel trade lines
  // marching through the zones at a steady beat.
  'plan-repetitive-work-with-takt-and-line-of-balance': (accent) => (
    <>
      ...
      <path d="M24 64 L60 20" stroke={C.blue} strokeWidth={2.2} strokeLinecap="round" fill="none" />
      ...
      <path d="M60 64 L96 20" stroke={accent} strokeWidth={2.2} strokeLinecap="round" fill="none" />
    </>
  ),

  // Produce a short-interval lookahead: the next weeks pulled off the programme
  // with the constraints cleared.
  'produce-a-short-interval-lookahead': (accent) => (
    <>
      <rect x={16} y={20} width={44} height={44} rx={3} fill={C.white} stroke={C.grey1} strokeWidth={1.6} />
      <rect x={16} y={20} width={44} height={9} rx={3} fill={C.blue} stroke="none" />
      <rect x={22} y={34} width={9} height={9} rx={1.5} fill={accent} stroke="none" />
      <rect x={34} y={34} width={9} height={9} rx={1.5} fill={C.blueLight} stroke="none" />
      <rect x={46} y={34} width={9} height={9} rx={1.5} fill={C.blueLight} stroke="none" />
  ...
  'project-end-to-end': (accent) => (
    <>
      <circle cx={20} cy={34} r={6} fill={C.blueLight} stroke="none" />
      <circle cx={40} cy={34} r={6} fill={C.blue} stroke="none" />
      <circle cx={60} cy={34} r={6} fill={C.blue} stroke="none" />
      <circle cx={80} cy={34} r={6} fill={C.blue} stroke="none" />
      <path d="M26 34 H34 M46 34 H54 M66 34 H74" stroke={C.grey1} strokeWidth={1.6} fill="none" />
      <rect x={92} y={26} width={14} height={18} rx={1} fill={C.blueDeep} stroke="none" />
      <path d="M91 26 L99 20 L107 26 Z" fill={C.blueDeep} stroke="none" />
      <path d="M18 54 H98" stroke={C.grey3} strokeWidth={4} strokeLinecap="round" />
      <path d="M18 54 H78" stroke={accent} strokeWidth={4} strokeLinecap="round" />
  ...
  'protect-the-programme-from-a-long-lead-item': (accent) => (
    <>
      <Sheet x={14} y={16} w={92} h={40} />
      <HeaderBand x={14} y={16} w={92} h={9} fill={C.blue} />
      <rect x={20} y={30} width={26} height={5} rx={2.5} fill={C.blueLight} stroke="none" />
      <rect x={40} y={39} width={30} height={5} rx={2.5} fill={C.blueLight} stroke="none" />
      ...
      <circle cx={92} cy={64} r={7} fill={C.white} stroke={accent} strokeWidth={1.8} />
      <path d="M92 60 v4 l3 2" stroke={accent} strokeWidth={1.6} fill="none" strokeLinecap="round" />
    </>
  ),

  // Review and mitigate the risk register: a risk moved from the red corner down
  // to green by its mitigation.
  'review-and-mitigate-project-risks': (accent) => (
    <>
      ...
      <path d="M57 30 L45 46" stroke={accent} strokeWidth={1.8} strokeDasharray="2 2" fill="none" />
  ...
  // owned action list.
  'run-a-progress-meeting-and-drive-the-actions': () => (
    <>
      <ellipse cx={38} cy={44} rx={22} ry={12} fill={C.panel} stroke={C.grey1} strokeWidth={1.4} />
      <circle cx={24} cy={36} r={4} fill={C.blue} stroke="none" />
      <circle cx={38} cy={32} r={4} fill={C.blueLight} stroke="none" />
      <circle cx={52} cy={36} r={4} fill={C.blue} stroke="none" />
      <circle cx={24} cy={52} r={4} fill={C.blueLight} stroke="none" />
      <circle cx={52} cy={52} r={4} fill={C.blueLight} stroke="none" />
      <Sheet x={72} y={18} w={32} h={48} />
      <HeaderBand x={72} y={18} w={32} h={9} fill={C.blue} />
  ...
  // first programme.
  'set-up-a-new-project': (accent) => (
    <>
      <Sheet x={20} y={16} w={40} h={54} />
      <HeaderBand x={20} y={16} w={40} h={10} fill={accent} />
      <RowBar x={26} y={20} w={18} h={3} fill={C.white} opacity={0.9} />
      <Badge cx={40} cy={46} r={11} fill={accent} glyph="plus" />
      ...
      <rect x={74} y={54} width={18} height={4} rx={2} fill={C.blueLight} stroke="none" />
      <rect x={80} y={61} width={20} height={4} rx={2} fill={C.blue} stroke="none" />
    </>
  ),

  // Update the programme and reforecast: real progress marked in, the finish
  // date reforecast and slipping to the right.
  'update-the-programme-and-reforecast': (accent) => (
    <>
      <Sheet x={14} y={16} w={92} h={54} />
      <HeaderBand x={14} y={16} w={92} h={9} fill={C.blue} />
      <rect x={22} y={30} width={30} height={5} rx={2.5} fill={C.grey3} stroke="none" />
      <rect x={22} y={30} width={22} height={5} rx={2.5} fill={C.blue} stroke="none" />
      <rect x={22} y={39} width={38} height={5} rx={2.5} fill={C.grey3} stroke="none" />
      <rect x={22} y={39} width={20} height={5} rx={2.5} fill={C.blue} stroke="none" />
      <rect x={22} y={48} width={28} height={5} rx={2.5} fill={C.grey3} stroke="none" />
      <rect x={22} y={48} width={10} height={5} rx={2.5} fill={C.blue} stroke="none" />
  ...
  'build-and-run-an-itp': () => (
    <>
      ...
      <Signature x={76} y={50} w={22} color={C.blue} />
    </>
  ),
  ...
  'clear-the-snag-list-before-handover': () => (
    <>
      ...
      <HeaderBand x={22} y={14} w={44} h={10} fill={C.blue} />
  ...
  'material-submittal-and-approval': (accent) => (
    <>
      ...
      <HeaderBand x={56} y={18} w={34} h={9} fill={C.blue} />
  ...
  'run-a-safety-walk-and-log-observations': () => (
    <>
      ...
      <HeaderBand x={64} y={16} w={40} h={9} fill={C.blue} />
  ...
  // controls are up.
  'toolbox-talk-and-safety': (accent) => (
    <>
      <circle cx={28} cy={30} r={6} fill={accent} stroke="none" />
      <path d="M18 50 c0 -8 5 -12 10 -12 s10 4 10 12 z" fill={accent} stroke="none" />
      <WarnTri cx={46} cy={26} w={12} fill={C.amber} />
      <Sheet x={60} y={18} w={44} h={50} />
      <HeaderBand x={60} y={18} w={44} h={9} fill={C.blue} />
  ...
  // certificate filed.
  'witness-and-record-mep-commissioning': () => (
    <>
      <path d="M16 40 H40 M28 40 V56" stroke={C.blue} strokeWidth={4} fill="none" strokeLinecap="round" />
      <circle cx={40} cy={30} r={10} fill={C.white} stroke={C.blue} strokeWidth={2} />
      <path d="M40 30 L45 25" stroke={C.red} strokeWidth={2} strokeLinecap="round" fill="none" />
      <circle cx={40} cy={30} r={1.6} fill={C.blueDeep} stroke="none" />
  ...
  'answer-an-rfi': (accent) => (
    <>
      ...
      <HeaderBand x={68} y={20} w={36} h={9} fill={C.blue} />
  ...
  'capture-daywork-and-time-and-materials': () => (
    <>
      ...
      <Chip x={32} y={30} w={9} h={7} fill={C.blue} label="L" />
      <RowBar x={44} y={31.5} w={20} h={3} fill={C.grey3} />
      <Chip x={32} y={42} w={9} h={7} fill={C.blueLight} label="P" />
      ...
      <Signature x={78} y={40} w={22} color={C.blue} />
  ...
  // one made current.
  'issue-a-controlled-drawing-revision': (accent) => (
    <>
      ...
      <path d="M52 40 H58" stroke={accent} strokeWidth={2} fill="none" />
  ...
  'issue-a-permit-to-work': (accent) => (
    <>
      ...
      <Signature x={30} y={54} w={22} color={C.blue} />
      <path
  ...
  'manage-the-plant-and-equipment-register': (accent) => (
    <>
      <path d="M14 40 l4 -8 h12 l3 8 z" fill={C.ochre} stroke="none" />
      <rect x={14} y={40} width={30} height={9} rx={1.5} fill={C.blueDeep} stroke="none" />
      <rect x={40} y={34} width={8} height={9} rx={1.5} fill={C.blue} stroke="none" />
      <circle cx={22} cy={52} r={4} fill={C.ink} stroke="none" />
      <circle cx={38} cy={52} r={4} fill={C.ink} stroke="none" />
      <Sheet x={56} y={16} w={48} h={40} />
      <HeaderBand x={56} y={16} w={48} h={9} fill={C.blue} />
      ...
      <path d="M62 64 a10 10 0 0 1 14 -7" fill="none" stroke={accent} strokeWidth={3} strokeLinecap="round" />
    </>
  ),

  // Prepare a method statement and risk assessment: the safe method with hazards
  // and controls, available on site.
  'prepare-a-method-statement-and-risk-assessment': () => (
    <>
      <Sheet x={20} y={14} w={44} h={56} />
      <HeaderBand x={20} y={14} w={44} h={10} fill={C.blue} />
      <RowBar x={26} y={18} w={22} h={3} fill={C.white} opacity={0.9} />
  ...
  // on the walk.
  'report-and-action-a-near-miss': (accent) => (
    <>
      ...
      <HeaderBand x={64} y={18} w={40} h={9} fill={C.blue} />
  ...
  // signed in.
  'run-a-toolbox-talk-and-record-attendance': (accent) => (
    <>
      <circle cx={26} cy={26} r={5} fill={accent} stroke="none" />
      <path d="M17 44 c0 -7 4 -11 9 -11 s9 4 9 11 z" fill={accent} stroke="none" />
      <circle cx={44} cy={30} r={3.4} fill={C.blueLight} stroke="none" />
      <circle cx={44} cy={42} r={3.4} fill={C.blueLight} stroke="none" />
      <circle cx={44} cy={54} r={3.4} fill={C.blueLight} stroke="none" />
      <Sheet x={58} y={16} w={46} h={54} />
      <HeaderBand x={58} y={16} w={46} h={9} fill={C.blue} />
      <Signature x={64} y={32} w={20} color={C.blue} />
      <Signature x={64} y={44} w={18} color={C.blue} />
      <Signature x={64} y={56} w={22} color={C.blue} />
    </>
  ),
  ...
  'track-a-design-change-to-site-record': (accent) => (
    <>
      ...
      <path d="M84 40 H92" stroke={accent} strokeWidth={2} fill="none" />
      <Badge cx={96} cy={40} r={8} fill={C.green} glyph="check" />
    </>
  ),
};
