...
const CHANGELOG: ChangelogEntry[] = [
  { version: '9.0.2', date: '2026-06-28', tag: 'FIX', summary: 'A PDF takeoff fix: measurements saved to a project now reappear after a page reload instead of leaving the sheet blank, because a re-render that happened while they were still loading could cancel the load even though the work was safely stored on the server. A drawing page that was never calibrated also no longer shows a "calibrated" scale badge after reload, since each measurement now records whether its page was actually calibrated.' },
