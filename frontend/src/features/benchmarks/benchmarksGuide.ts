  ...
  sections: [
    {
      ...
      bodyDefault:
        'A benchmark is the typical cost to build one square metre of a given building type, drawn from public datasets like BKI, BCIS and ENR. It covers DIN 276 KG300 construction works plus KG400 technical systems. It is a planning reference, not a live price feed.',
